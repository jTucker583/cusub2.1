...
#include "custom_interfaces/srv/detail/detect_objects__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces::srv::DetectObjects_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::srv::DetectObjects_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::srv::DetectObjects_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::srv::DetectObjects_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::srv::DetectObjects_Request *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_DetectObjects_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, DetectObjects_Request)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_DetectObjects_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interfaces
cdr_serialize(
  const custom_interfaces::srv::DetectObjects_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: object_names
  {
    cdr << ros_message.object_names;
  }
  // Member: object_positions_x
  {
    cdr << ros_message.object_positions_x;
  }
  // Member: object_positions_y
  {
    cdr << ros_message.object_positions_y;
  }
  // Member: confidence
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::srv::DetectObjects_Response & ros_message)
{
  // Member: object_names
  {
    cdr >> ros_message.object_names;
  ...
  size_t current_alignment)
{
  ...
  // Member: object_names
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.object_names[index].size() + 1);
    }
  }
  // Member: object_positions_x
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.object_positions_x[0]);
  ...
  // Member: object_positions_y
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.object_positions_y[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: confidence
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces::srv::DetectObjects_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::srv::DetectObjects_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interfaces::srv::DetectObjects_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_DetectObjects_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, DetectObjects_Response)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_DetectObjects_Response__handle;
}
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_DetectObjects__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, DetectObjects)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_DetectObjects__handle;
}
